...
Le fichier test\_comp quant à lui, parse certains fichiers de test afin d'en extraire certains segments problématiques et en vérifier la bonne comparaison, vérifiant ainsi la qualité de comparaison des segments.
